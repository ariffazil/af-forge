...
4. **DITEMPA BUKAN DIBERI:** Capacity is forged through discipline, not granted by default.

## III. WELL Floors (W-Floors)
- **W1 — Sleep Integrity:** Blocks strategic action if debt > 2 nights.
- **W5 — Cognitive Entropy:** Throttles bandwidth if clarity < 4/10.
