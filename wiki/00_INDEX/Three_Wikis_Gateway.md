...
> **Purpose:** Make GEOX feel native inside the larger arifOS federation.  
> **Status:** ACTIVE  
> **Authority:** 888_JUDGE

The full system is not just GEOX.
It is a **three-wiki federation**:
...
GEOX is the **domain truth organ**.

It should be entered when the work involves:
- geology
- wells
- seismic
- petrophysics
- basin interpretation
- physical uncertainty in subsurface claims
